...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../Recursos/CSS/titulo_crono.css" media="screen" />
  ...
  <body>
    ...
    <audio loop autoplay>
        <source src="../Recursos/Audio/level.mp3" type="audio/mp3">
    </audio>

    <div align="center">
      <h1 class="header" id="turnos"></h1>
      <h2 class="header" id="cronometro">20</h2>
       <input id="pokemon" hidden value="<?php echo $pokemon;?>"></input>
            ...
            <div class="img_2" >
                ...
                <br><br>
                <div align="center" id="botones_Ene">
